...
import java.util.Scanner;
 ...
 class SplayTree
 {
     ...
     public ArrayList<Integer> insert(int ele)
     {  
 ...
 public class SplatTreeTest
 {  
    static ArrayList<Integer> arr= new ArrayList<Integer>();
    public static void main(String[] args)
    {            
        Scanner scan = new Scanner(System.in);
        SplayTree spt = new SplayTree();/**object creation**/ 
        System.out.println("SPLAY TREE TESTING FOR DELETION OF RECENTLY USED DATA IN TREE\n");          
        char ch;
        ...
        do    
        {
            ...
            System.out.println("5. CHECK EMPTYNESS");
            System.out.println("6. DELETE FULL TREE");
            ...
            case 1 : 
                ...
                break;
            case 2 : 
                /*Used for deleting multiple occurences of recently used-data*/
                System.out.println("Enter integer element to remove");
                int x=scan.nextInt();
               // spt.remove( x );  
                int y=Collections.frequency(arr, x);
